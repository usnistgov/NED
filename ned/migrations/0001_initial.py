# Generated by Django 4.2.16 on 2025-04-18 22:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fragility_group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ned.fragility_group')),
        ...
        migrations.CreateModel(
            name='Experiment_fragility_group',
            fields=[
                ('id', models.CharField(max_length=255, primary_key=True, serialize=False, verbose_name='id')),
                ('experiment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ned.experiment')),
                ('fragility_group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ned.fragility_group')),
            ],
        ),
        migrations.AddField(
            ...
            name='nistir',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ned.nistir'),
        ),
        migrations.AddField(
            model_name='experiment',
            name='reference',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ned.reference'),
        ),
    ]
