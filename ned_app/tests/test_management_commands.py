    ...
    def test_export_data_command(self):
        ...
        for filename in expected_files:
            ...
            with open(file_path, 'r') as f:
                data = json.load(f)
                self.assertIsInstance(data, list, f"Data in {filename} is not a list")
        ...
        with open(os.path.join(self.temp_dir, "reference.json"), 'r') as f:
            ...
            self.assertEqual(ref_data["csl_data"]["container-title"], "Journal of Building Engineering")
        ...
        with open(os.path.join(self.temp_dir, "component.json"), 'r') as f:
            ...
            self.assertEqual(comp_data["id"], "B2011.A")
        ...
        with open(os.path.join(self.temp_dir, "experiment.json"), 'r') as f:
            ...
            self.assertEqual(exp_data["design_objective"], "Life safety performance level")
            self.assertIn("comp_description", exp_data)
            self.assertEqual(exp_data["comp_description"], "Test component description")
            self.assertIn("ds_description", exp_data)
            self.assertEqual(exp_data["ds_description"], "Test damage state description")
            ...
            self.assertEqual(exp_data["alt_edp_metric"], "Peak Floor Acceleration, horizontal")
        ...
        with open(os.path.join(self.temp_dir, "fragility_model.json"), 'r') as f:
            ...
            self.assertEqual(fm_data["comp_description"], "Test fragility model description")

        # Verify bridge data
        with open(os.path.join(self.temp_dir, "experiment_fragility_model_bridge.json"), 'r') as f:
            ...
            self.assertEqual(len(bridge.keys()), 2, "ExperimentFragilityModelBridge should only have 2 fields")
        ...
        with open(os.path.join(self.temp_dir, "fragility_curve.json"), 'r') as f:
            ...
            self.assertEqual(curve["ds_description"], "Test damage state description")
